    ...
    def main():
        ...
        <div class='tableauPlaceholder' id='viz1680486651064' style='position: relative'>
            ...
            <script type='text/javascript'>
                var divElement = document.getElementById('viz1680486651064');
        ...
        """
        components.html(html_temp, width=None, height=1200, scrolling=True)
...
with tab3:
    def main():
        html_temp = """
        <div class='tableauPlaceholder' id='viz1680487171300' style='position: relative'>
          <noscript>
            <a href='#'>
          ...
          <script type='text/javascript'>
            var divElement = document.getElementById('viz1680487171300');
            var vizElement = divElement.getElementsByTagName('object')[0];
            if (divElement.offsetWidth > 800) {
              vizElement.style.width = '1100px';
              vizElement.style.height = '527px';
